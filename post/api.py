...
from post.serializers import PostSerializer, UserSerializer, UserRegistrationSerializer,FollowerSerializer
	#,UserPostsSerializer
...
class FollowViewSet(ModelViewSet):
	...
	def create(self,request,*args,**kwargs):
		...
		Follow.objects.create(follower=request.user,following=post)
